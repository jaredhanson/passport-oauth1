...
var passport = require('passport-strategy')
  ...
  , GenericRequestTokenStore = require('./requesttoken/generic')
...
function OAuthStrategy(options, verify) {
  ...
  if (options.requestTokenStore) {
    this._requestTokenStore = options.requestTokenStore;
  } else {
    ...
    case undefined:
      ...
      break;
    case 'generic':
      this._requestTokenStore = new GenericRequestTokenStore();
      break;
    default:
      throw new TypeError('Unsupported OAuth request token store: ' + options.state);
    }
  }
